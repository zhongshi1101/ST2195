...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll(
        '.experience-card, .project-card, .timeline-item, .skill-category, .stat-item'
    );
...
document.addEventListener('DOMContentLoaded', () => {
    const elements = document.querySelectorAll('.about-description, .skills-section, .contact-info');
    elements.forEach(el => {
